...
public class HourlyJobListFragment extends Fragment {


    public HourlyJobListFragment() {
    ...
    public void onAttach(@NonNull Context context) {
        ...
        ((MainActivity) getActivity()).mSetMainActivityTitle("Hourly Jobs");//this line for setting a title for this fragment.
    }
    public HourlyJobListFragment(List<JobModel> allHourlyJobList, List<AppliedJobModel> allApplied, String userId, Activity activity) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        v = inflater.inflate(R.layout.fragment_hourly_job_list, container, false);
        rv_hourly = (RecyclerView) v.findViewById(R.id.rv_hourly_job_fragment_rv_id);
        ...
        rv_hourly.setAdapter(adapter);
        rv_hourly.setLayoutManager(new LinearLayoutManager(getActivity()));
